...
import 'favoris.dart' as _i8;
import 'follower.dart' as _i9;
import 'track_comments.dart' as _i10;
import 'tracks.dart' as _i11;
import 'package:sama3ni_client/src/protocol/artists.dart' as _i12;
import 'package:sama3ni_client/src/protocol/categories.dart' as _i13;
import 'package:sama3ni_client/src/protocol/track_comments.dart' as _i14;
import 'package:sama3ni_client/src/protocol/favoris.dart' as _i15;
import 'package:sama3ni_client/src/protocol/follower.dart' as _i16;
import 'package:sama3ni_client/src/protocol/tracks.dart' as _i17;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i8.Favoris) {
      return _i8.Favoris.fromJson(data) as T;
    }
    if (t == _i9.Follower) {
      return _i9.Follower.fromJson(data) as T;
    }
    if (t == _i10.Comments) {
      return _i10.Comments.fromJson(data) as T;
    }
    if (t == _i11.Track) {
    ...
    if (t == _i1.getType<_i8.Favoris?>()) {
      return (data != null ? _i8.Favoris.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i9.Follower?>()) {
      return (data != null ? _i9.Follower.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i10.Comments?>()) {
      return (data != null ? _i10.Comments.fromJson(data) : null) as T;
    }
    ...
    if (t == _i1.getType<List<_i9.Follower>?>()) {
      return (data != null
          ? (data as List).map((e) => deserialize<_i9.Follower>(e)).toList()
          : null) as dynamic;
    }
    if (t == _i1.getType<List<_i9.Follower>?>()) {
      return (data != null
    ...
    if (t == _i1.getType<List<_i8.Favoris>?>()) {
      return (data != null
          ? (data as List).map((e) => deserialize<_i8.Favoris>(e)).toList()
          : null) as dynamic;
    }
    if (t == _i1.getType<List<_i8.Favoris>?>()) {
      return (data != null
    ...
    if (t == List<_i14.Comments>) {
      return (data as List).map((e) => deserialize<_i14.Comments>(e)).toList()
          as dynamic;
    }
    if (t == List<_i15.Favoris>) {
      return (data as List).map((e) => deserialize<_i15.Favoris>(e)).toList()
          as dynamic;
    }
    if (t == List<_i16.Follower>) {
      return (data as List).map((e) => deserialize<_i16.Follower>(e)).toList()
          as dynamic;
    }
    if (t == List<_i17.Track>) {
      return (data as List).map((e) => deserialize<_i17.Track>(e)).toList()
          as dynamic;
    }
    try {
  ...
  String? getClassNameForObject(Object? data) {
    ...
    if (data is _i8.Favoris) {
      return 'Favoris';
    }
    if (data is _i9.Follower) {
      return 'Follower';
    }
    if (data is _i10.Comments) {
      return 'Comments';
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'Favoris') {
      return deserialize<_i8.Favoris>(data['data']);
    }
    if (dataClassName == 'Follower') {
      return deserialize<_i9.Follower>(data['data']);
    }
    if (dataClassName == 'Comments') {
      return deserialize<_i10.Comments>(data['data']);
    }
